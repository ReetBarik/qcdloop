...
namespace ql
{
    ...
    */
    ...
    void BIN3(
        ...
        res(i, 0) = (
            ...
            TOutput{0.0, 2.0 * ql::Constants::_pi<TOutput, TMass, TScale>()} *
    ...
    */
    ...
    void BIN4(
        ...
        const TScale gamma = ql::Sign(ql::Real(a*(x[1][3] - x[0][3])) + ql::Constants::_reps<TOutput, TMass, TScale>);
        TOutput l[2][4];
        for (int i = 0; i < 2; i++)
            for (int j = 0; j < 4; j++)
                l[i][j] = TOutput(0.0);
    ...
    */
    ...
    void B1(
        ...
        res(i,0) = fac * (lnrat_tamu2 * lnrat_tamu2 + lnrat_simu2 * lnrat_simu2 - lnrat_tasi * lnrat_tasi - TOutput(ql::Constants::_pi2<TOutput, TMass, TScale>()));
    }
    ...
    */
    ...
    void B2(
        ...
        res(i,0) = fac * (-ln_mp4_mu2 * ln_mp4_mu2 + ln_ta_mu2 * ln_ta_mu2 + ln_si_mu2 * ln_si_mu2
                    + TOutput(2.0) * (ql::Li2omrat<TOutput, TMass, TScale>(ta, mp4sq) + ql::Li2omrat<TOutput, TMass, TScale>(si, mp4sq) - TOutput(ql::Constants::pi2o6<TOutput, TMass, TScale>()))
    ...
    */
    ...
    void B3(
        ...
        if (Kokkos::abs(r) < ql::Constants::_eps<TOutput, TMass, TScale>() && landau == false) {
            // Expanded case
            const TOutput fac = TOutput(1.0) / (si * ta);
            const TOutput ln_si_mu2 = ql::Lnrat<TOutput, TMass, TScale>(si, mu2);
    ...
    */
    ...
    void B6(
        ...
        res(i,0) = wlogm * wlogm - wlogm * (TOutput(2.0) * wlogt + wlogs) 
                + TOutput(2.0) * wlogt * wlogs - TOutput(0.5) * ql::Constants::pi2<TOutput, TMass, TScale>();
    ...
    */
    ...
    void B7(
        ...
        res(i,0) = TOutput(2.0) * wlogs * wlogt - wlogp * wlogp - TOutput(ql::Constants::pi2o12<TOutput, TMass, TScale>() * 5.0)
    ...
    */
    ...
    void B8(
        ...
        res(i,0) = -TOutput(2.0) * dilog3 - TOutput(2.0) * dilog4 - dilog34
                - TOutput(ql::pi2o6<TOutput, TMass, TScale>()) + TOutput(0.5) * (ln_si_mu2 * ln_si_mu2 - ql::kPow<TOutput, TMass, TScale>(ql::Lnrat<TOutput, TMass, TScale>(si, msq), 2))
    ...
    */
    ...
    void B9(
        ...
        res(i,2) = TOutput(0.5);
        res(i,1) = -wlogt - wlog2;
        res(i,0) = dilog1 + 2.0 * dilog2 + TOutput(ql::Constants::pi2o12<TOutput, TMass, TScale>()) + (wlogt + wlog2) * (wlogt + wlog2);
    ...
    */
    ...
    void B11(
        ...
        TScale ieps2;
        if (ql::iszero<TOutput, TMass, TScale>(ql::ql::Imag(root))) {
    ...
    */
    ...
    void B12(
        ...
        res(i,2) = TOutput(0.5);
        res(i,1) = -wlog;
        res(i,0) = -TOutput(ql::Constants::pi2o12<TOutput, TMass, TScale>())
    ...
    */
    ...
    void B14(
        ...
        const TScale imxs = ql::ql::Imag(cxs[0]);
    ...
    */
    ...
    void B15(
        ...
        const TScale imxs = ql::ql::Imag(xs);
    ...
    */
    ...
    void B16(
        ...
        if (ql::iszero<TOutput, TMass, TScale>(rexs - 1.0) && ql::iszero<TOutput, TMass, TScale>(imxs)) {
            ...
            if (ql::iszero<TOutput, TMass, TScale>(ql::Real(cx2[0] - cx3[0])) && ql::iszero<TOutput, TMass, TScale>(ql::ql::Imag(cx2[0] - cx3[0]))
                && ql::iszero<TOutput, TMass, TScale>(ql::Real(cx2[0] - 1.0)) && ql::iszero<TOutput, TMass, TScale>(ql::ql::Imag(cx2[0])))
                res(i,0) += TOutput(4.0);
            else if (ql::iszero<TOutput, TMass, TScale>(ql::Real(cx2[0] - cx3[0])) && ql::iszero<TOutput, TMass, TScale>(ql::ql::Imag(cx2[0] - cx3[0])))
