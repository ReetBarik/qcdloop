...
int main(int argc, char* argv[]) {
    Kokkos::initialize(argc, argv);
    {
        ...
        // two mass integrals
        __float128 m22 = 4.9q*4.9q;
        __float128 m32 = 10.0q;
        __float128 m42 = 50.0q*50.0q;

        // B13
        for (size_t i(0); i<batch_size; ++i) {
            m_h(i, 0) = static_cast<fp128_t>(0.0q); m_h(i, 1) = static_cast<fp128_t>(0.0q); m_h(i, 2) = static_cast<fp128_t>(m32); m_h(i, 3) = static_cast<fp128_t>(m42);
            p_h(i, 0) = static_cast<fp128_t>(0.0q);
            p_h(i, 1) = static_cast<fp128_t>(rs(low,up)); p_h(i, 2) = static_cast<fp128_t>(rs(low,up)); p_h(i, 3) = static_cast<fp128_t>(rs(low,up));
