...
int main(int argc, char* argv[]) {
    Kokkos::initialize(argc, argv);
    {
        ...
        // B16
        for (size_t i(0); i<batch_size; ++i) {
            m_h(i, 0) = static_cast<fp128_t>(0.); m_h(i, 1) = static_cast<fp128_t>(m22); m_h(i, 2) = static_cast<fp128_t>(m32); m_h(i, 3) = static_cast<fp128_t>(m42);
            p_h(i, 0) = static_cast<fp128_t>(m22);
            p_h(i, 1) = static_cast<fp128_t>(rs(low,up)); p_h(i, 2) = static_cast<fp128_t>(rs(low,up)); p_h(i, 3) = static_cast<fp128_t>(m42);
