...
int main(int argc, char* argv[]) {
    Kokkos::initialize(argc, argv);
    {
        ...
        for (size_t i(0); i<batch_size; ++i) {
            ...
            p_h(i, 0) = static_cast<fp128_t>(0.); p_h(i, 1) = static_cast<fp128_t>(rs(low,up)); p_h(i, 2) = static_cast<fp128_t>(0.);
            p_h(i, 3) = static_cast<fp128_t>(rs(low,up)); p_h(i, 4) = static_cast<fp128_t>(r(low,up)); p_h(i, 5) = static_cast<fp128_t>(r(low,up));
        }
